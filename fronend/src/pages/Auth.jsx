  ...
  return (
    <div className="bg-background dark:bg-background-dark min-h-[calc(100vh-64px)] flex items-center justify-center p-4">
      <motion.div 
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        className="bg-white dark:bg-cardDark w-full max-w-md rounded-lg shadow-xl border border-gray-100 dark:border-gray-800 overflow-hidden"
      >
        <div className="p-8">
          ...
          <div className="flex bg-gray-100 dark:bg-gray-800 p-1 rounded-md mb-6">
            <button
              type="button"
              onClick={() => setUserType('customer')}
              className={`flex-1 py-2 text-sm font-medium rounded-md transition-all ${userType === 'customer' ? 'bg-white dark:bg-cardDark shadow text-primary' : 'text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200'}`}
            >
              Customer
            </button>
            <button
              ...
              className={`flex-1 py-2 text-sm font-medium rounded-md transition-all ${userType === 'vendor' ? 'bg-white dark:bg-cardDark shadow text-primary' : 'text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200'}`}
            >
              Vendor
            </button>
          </div>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white dark:bg-cardDark text-gray-500">Or continue with</span>
              </div>
            </div>
            ...
            <div className="mt-6 gap-3">
              <button 
                ...
                disabled={isLoading}
                className={`w-full flex items-center justify-center py-2 px-4 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm bg-white dark:bg-gray-800 text-sm font-medium text-gray-500 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors ${isLoading ? 'opacity-70 cursor-not-allowed' : ''}`}>
