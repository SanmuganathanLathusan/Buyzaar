                ...
                {cartItems.map((item) => (
                  ...
                  >
                    ...
                    <Link
                      ...
                      className="w-20 h-20 sm:w-24 sm:h-24 flex-shrink-0 rounded-xl overflow-hidden bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-800 dark:to-slate-900 border border-border dark:border-border-dark flex items-center justify-center"
                    >
                      <img
                        src={item.image}
                        alt={item.title}
